...
<body class="MaxZindex">
	<div>
		...
		<div class="common_box">
			<div class="login">
				<div class="common_title">《飞讯WiFi常见问题》</div>
				<div class="common_text">
					...
					<p class="ans">
						答:（1）可能信号不稳定或较弱，信息数据丢失率大。<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）可能用户所连接的WLAN接入点(即AP设备)容量已达到饱和值。<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（3）当前处于使用高峰期，并发访问用户人数多，网络通道拥挤。
					</p>
					<div class="qus">3.已经成功认证了，为什么还会掉线?</div>
					<p class="ans">
						答:（1）可能是该区域信号不稳定或很弱。<br /> 
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;（2）可能用户超过15分钟未产生任何流量或当天免费时长用完将被强制下线。<br />
