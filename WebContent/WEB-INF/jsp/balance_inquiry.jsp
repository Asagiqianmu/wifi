...
<body>
	<div class="main">
		<div class="head">
			<div class="head_img">
				<img class="img" alt="" src="${statics}/images/daoqi_time.png">
			</div>
		</div>
		<div class="menubar">
		...
		<div class="tel_center">
			...
			<input type="button" id="tel_but"
				class="center_but center_but_disabled" value="查询"
				disabled="disabled">
		</div>
...
<script type="text/javascript">
	...
	$("#sure").click(function() {
		...
		$(".model_cover").css("display", "none");
		$(".model").css("display", "none");
		window.location.href = "${ctx}/PROT/personalCenter?userName="+tel+"&siteId="+siteId;
	});
