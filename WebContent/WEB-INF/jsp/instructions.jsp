...
<body class="MaxZindex">
	<div>
		...
		<div class="common_box">
			<div class="login">
				<div class="common_title">《深圳公共无线局域网使用说明》</div>
				<div class="common_text">
					<p class="act">1."深圳公共无线局域网"是由深圳市人民政府提供的免费WLAN网络，是一项利民、便民、惠民的民生工程，旨在为公众提供更多"信息福利"。</p>
					<p class="act">2.WLAN网络的稳定性与周边障碍物（树、墙壁、栅栏、车辆等）、电磁环境（同频干扰、微波炉干扰等）、天气等有密切关系，所以稳定性不及有线网络，影响用户体验。此外，用户终端本身信号发射功率大小也在一定程度上影响用户体验。</p>
					<p class="act">3."深圳公共无线局域网"支持中国移动、中国电信、中国联通三家运营商手机号码认证上网。</p>
					<p class="act">4."深圳公共无线局域网"支持智能手机、平板电脑、笔记本电脑等具有无线上网功能的终端接入上网。</p>
					<p class="act">5.成功登录"深圳公共无线局域网"后，若终端连续15分钟无流量时，认证系统自动将用户作下线处理。用户重新登录即可正常使用。</p>
				</div>
