...
<c:set var="mobilePath" value="${ctx}/deck/mobile" />
<c:set var="img" value="${ctx}/deck/mobile/img/newimg" />
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css"
	href="${mobilePath}/css/newcss/common.css">
...
<body oncontextmenu=self.event.returnValue=false>
	<div class="cw"></div>
	<p class="links">
		亲,您打开的页面不存在<br>点此<a href="javascript:history.back(-1)">返回</a>
	</p>
