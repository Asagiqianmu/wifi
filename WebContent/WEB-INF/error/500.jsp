...
<c:set var="cssPath" value="${ctx}/deck/mobile/css" />
<c:set var="imgPath" value="${ctx}/deck/mobile/img" />

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Unite-WiFi</title>
...
<body style="table-layout: fixed; word-break: break-all">
	<div id='message'>
		<p>
			<a href="http://www.gonet.cc/"> <img alt="Unite-WiFi"
				src="${imgPath}/LOGO.gif" border=0></a>
		</p>
		<p></p>
