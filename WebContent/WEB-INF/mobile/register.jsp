...
<body>
	<div class="main">
		...
		<div class="loginwrap">
			<div class="login">
				<form>
					<div class="newlogin">
						...
						<div style="margin-top: 20px; color: #b1b1a7; font-size: 14px;">港澳台号码无需在号码前加地区号</div>
					</div>
					<div class="loginpassword" style="display: none;">
						...
						<div class="validate clearfix">
							<input type="text" maxlength='6' id="valiHtml"
					...
					<div class="loginpicpassword" style="display: none;">
						...
						<div class="validate clearfix">
							<input type="text" maxlength='6' id="inputCode"
			...
			<!-- <a herf="">
				<div style="margin-top:30px;text-align: center;cursor: pointer; font-size: 13px;color: #40affe;font-weight: bold;">
				   港澳台用户一键登录
				</div>
				</a> -->
		</div>
