...
<script type="text/javascript">
	$(function() {
		...
		$("#BtnLogin").click(function() {
			...
			return;
			if($("#siteType").val()==1 || $("#siteType").val()==4){
				accountLogin(mobile, password);
			}else{
				newLogin(mobile, "123", 1);
			}
		});
...
<body class="MaxZindex">
	<div>
			...
			<div class="login">
				...
				<div class="pass_put">
					<div class="pass_left">
						...
						<input style="width: 68%;" type="text" id="password" name=""
				...
				<div class="input_box left_input_box">
					...
					<label for="Remember"></label><span>同意遵守</span><a
						href="${ctx}/login/userAgreement">用户协议/Agree&nbsp;To&nbsp;User&nbsp;Agreement</a>
				</div>
		...
		<div class="footer_about">
			<ul>
				<li><a href="${ctx}/login/common_problem">常见问题<br />Common&nbsp;&nbsp;problem
				</a></li>
				<li><a href="${ctx}/login/instruction">使用说明<br />Instructions
				</a></li>
				<li><a href="${ctx}/login/feedback">意见反馈<br />Feedback
				</a></li>
			</ul>
		</div>
