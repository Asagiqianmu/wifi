...
<link rel="stylesheet" href="${ctx}/static/css/Wireless_Nanshan.css" />
<link rel="stylesheet" href="${ctx}/static/css/portal.css" />
<script src="${ctx}/partol/js/jquery.min.js"></script>
<script type="text/javascript" src="${ctx}/static/layer/layer/layer.js"></script>
<script src="${ctx}/static/js/Wireless_Nanshan.js"></script>
<script src="${ctx}/static/js/validator.js"></script>
