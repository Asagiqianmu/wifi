 ...
 */
	...
	public String toString() {
		return "PortalLog [TerminalDevice=" + TerminalDevice + ", requestTime="
				+ requestTime + ", routerMac=" + routerMac + ", clientMac="
				+ clientMac + ", routerIp=" + routerIp + ", clientIp="
				+ clientIp + ", routerType=" + routerType + ", url=" + url
				+ ", nasid=" + nasid + "]";
	}
}
