...
public class CloudSiteRouters {
	...
	public String toString() {
		return "CloudSiteRouters [id=" + id + ", siteId=" + siteId + ", mac=" + mac + ", createTime=" + createTime + ", ip=" + ip + ", routerType=" + routerType + ", secretKey=" + secretKey
				+ ", installPosition=" + installPosition + ", nasid=" + nasid + ", startupTime=" + startupTime + ", lastTime=" + lastTime + "]";
	}
