...
//	public static String notify_url = "http://portal.solarsys.cn/deck/pay/aliPayNotify";
	public static String notify_url = SetSystemProperty.propertyName("url")+SetSystemProperty.propertyName("UnitePortal")+"/pay/aliPayNotify";
...
//	public static String call_back_url = "http://portal.solarsys.cn/deck/mobile/result.jsp";
	public static String call_back_url =SetSystemProperty.propertyName("url")+SetSystemProperty.propertyName("UnitePortal")+"/priceConfig/payResult";
